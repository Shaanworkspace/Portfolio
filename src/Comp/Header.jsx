...
const Header = () => {
    const socialLinks = [
        {
            icon: <FaInstagram className="text-neutral-300 text-lg md:text-2xl group-hover:text-purple-400 transition-colors duration-300" />,
            href: 'https://www.instagram.com/shaan.yadv', // Placeholder, replace with your actual Instagram
            label: 'Instagram',
        },
        {
            icon: <FaLinkedinIn className="text-neutral-300 text-lg md:text-2xl group-hover:text-purple-400 transition-colors duration-300" />,
            href: 'https://www.linkedin.com/in/shaanyadv/', // Placeholder, replace with your actual LinkedIn
            label: 'LinkedIn',
        },
        {
            icon: <FaGithub className="text-neutral-300 text-lg md:text-2xl group-hover:text-purple-400 transition-colors duration-300" />,
            href: 'https://github.com/Shaanworkspace',
            label: 'GitHub',
        },
        {
            icon: <FaXTwitter className="text-neutral-300 text-lg md:text-2xl group-hover:text-purple-400 transition-colors duration-300" />,
            href: 'https://x.com/ShaanYadav54660', // Placeholder, replace with your actual Twitter
            label: 'Twitter',
        },
        {
            icon: <FaMedium className="text-neutral-300 text-lg md:text-2xl group-hover:text-green-400 transition-colors duration-300" />,
