...
const Experience = () => {
    return (
        <div className='border-b border-neutral-900 pb-2 lg:mb-32 lg:mt-0'>
            <h2 className='mb-15 text-center  text-4xl lg:text-4xl'>Projec<span className='tracking-tighter text-neutral-500'>ts</span></h2>
            <div className="container mx-auto px-4">
                {PROJECTS.map((project, index) => (
                    <div
                        key={index}
                        className="mb-12 flex flex-wrap lg:flex-nowrap lg:justify-center gap-6 group"
                    >
             ...
             transition-shadow duration-500 w-full h-64 object-cover group-hover:scale-105"
                        ...
                        {/* Main Content */}
                        <div className="w-full lg:w-2/3 max-w-2xl bg-neutral-900 p-6 rounded-2xl shadow-lg border border-neutral-800 transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-xl group-hover:border-purple-700">
